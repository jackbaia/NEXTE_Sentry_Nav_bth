...
def transform_fusion():
    ...
    while True:
        ...
        # TODO: Pay attention to thread safety here
        ...
        if cur_odom is not None:
            ...
            # T_map_to_odom changes slowly in short time, temporarily not considering time synchronization with T_odom_to_base_link
